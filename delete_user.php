<!-- This page makes it possible for admins to delete users
 -->
<?php
...
// If a user the admin is logged in, the user selected will get deleted from the table projectuser
...
END;
 $mysqli->query($query);
 // A messge will be printed on the screen showing that the user got deleted.
 echo 'User ' . $_POST['username'] . 'was deleted from the database!';
 
// The user will the be located at the page edituser.php
