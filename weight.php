...
if (isset($_POST['dates']) AND isset($_POST['weight']) AND isset($_SESSION['userId'])) {
    ...
    $query = <<<END
    INSERT INTO Weight(id, dates, weight)
    VALUES('{$_SESSION['userId']}','{$_POST['dates']}','{$_POST['weight']}')
    ON DUPLICATE KEY UPDATE weight = '{$_POST['weight']}';
END;
...
<div class=container>
    ...
    <div class="row">
        ...
        <form method="post" action="weight.php" id="formen">
            <h3 id="header">Weight metrics for a day</h3>
            <br>
            ...
            <br>
            <input type="number" name="weight" id="weiID" required></input>
            <br>
    ...
    <div class="row"  class="row" style="margin-top: 20px; margin-left: 30px;">
        ...
        <div class="alert alert-warning alert-dismissible fade hidden" role="alert" id="subAlert">
            ...
            <br>Your weight have been successfully added.
