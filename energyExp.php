...
if (isset($_POST['dates']) AND isset($_POST['burnedKcal']) AND isset($_SESSION['userId'])) {
    ...
    $query = <<<END
    INSERT INTO Calories(id, dates, burnedKcal)
    VALUES('{$_SESSION['userId']}','{$_POST['dates']}','{$_POST['burnedKcal']}')
    ON DUPLICATE KEY UPDATE burnedKcal = '{$_POST['burnedKcal']}';
END;
...
<div class=container>
    ...
    <div class="row">
       ...
       <!-- Buttons to navigate between pages used for inserting data to the DB-->
        ...
        <form method="post" action="energyExp.php" id="formen">
            <h3 id="header">Burned calories metrics for a day</h3>
            <br>
            <label for="dateID" id="lab1">Choose date</label>
            <br>
            <input type="date" name="dates" id="dateID" required></input>
            <br>
            <label for="brunID" id="lab3">Calories burned</label>
            <br>
            <input type="number" name="burnedKcal"  id="burnID" required></input>
            <br>
            <br>
    ...
    <div class="row"  class="row" style="margin-top: 20px; margin-left: 30px;">
        ...
        <div class="alert alert-warning alert-dismissible fade hidden" role="alert" id="subAlert">
            ...
            <br>Numbr of burned calories have been successfully added.
